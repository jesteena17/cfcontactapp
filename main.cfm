      ...
      <script src="js/bootstrap.bundle.min.js"></script>
       <cfset variables.message=""/>
           <!--  added new -->
       <cfdump var=#session.stLoggedInUser.userID#/>
          <!--  end added new -->
                                                            ...
                                                            <cfloop array="#allcontacts#" item="allcontacts">
                                                                 <tr>
                                                                      ...
                                                                      <td>
                                                                           ...
                                                                           <a class="btn btn btn-outline-primary btn-sm rounded-pill px-3"  href="del_contact.cfm?die=#URLEncodedFormat(Encrypt(allcontacts.getCid(), "#key#"))#">
                                                                                Delete
                                                                           </a>
                                                                      </td>
                                                                      <td>
...
<cfif StructKeyExists(session.valconresult, "error10") > 
