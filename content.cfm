          ...
          <output>
               <div class="container">
                    <div class="row m-5 no-gutters shadow-lg logindiv">
                         <div
                              class="col-md-3 d-none d-md-block bg1 d-flex justify-content-center align-items-center logindivleft">
                              <i class="fa-regular fa-address-book" style="color:white;vertical-align: middle;"></i>
                         </div>
                         <div class="col-md-8 bg-white p-5 logindivright">
                              <h3 class="pb-3">Sign Up Form</h3>
                              <div class="form-style">
                                   <form action="" method="post">
                                        <div class="form-group pb-3">
                                             <input type="text" name="fullname" id="fullname" placeholder="Fullname"
                                                  class="form-control-lg w-100" aria-describedby="emailHelp">
                                        </div>
                                        ...
                                        <div class="form-group pb-3">
                                             <input type="password" name="cpassword" id="cpassword"
                                                  placeholder="Confirm Password" class="form-control-lg w-100">
                                        </div>
                                        <div class="pb-2">
                                             <button type="submit"
